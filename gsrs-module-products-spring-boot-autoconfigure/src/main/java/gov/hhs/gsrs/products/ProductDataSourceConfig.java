...
@EnableJpaRepositories(
        entityManagerFactoryRef = ProductDataSourceConfig.NAME_ENTITY_MANAGER,
        transactionManagerRef = ProductDataSourceConfig.NAME_TRANSACTION_MANAGER,
        basePackages = {"gov.hhs.gsrs.products"}
)
@Slf4j
public class ProductDataSourceConfig extends GSRSDataSourceConfig {
    ...
    protected static final String[] BASE_PACKAGES = new String[] {"gov.hhs.gsrs.products"};
    protected static final String PERSIST_UNIT = "product";
